...
namespace TetrioVirtualEnvironment
{
    public class GameData
    {
        public GameData(EventFullOptions optionsdata, bool is_ttrm, Environment environment, ref GameData gameData)
        {
            ...
            Next =new List<int>( new int[(int)optionsdata.nextcount]);
        ...
        public GameData(EventFullOptions optionsdata, bool is_ttrm, Environment environment, ref GameData gameData,
            int[] field, int[] next, int hold, int now)
        {
            gameData = this;
            ...
            Falling.Init(now, environment.EnvironmentMode);
        }
